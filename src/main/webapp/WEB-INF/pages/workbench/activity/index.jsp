			...
			$("#importActivityBtn").click(function () {
				...
				formData.append("userName","张三");
				  $.ajax({
					  ...
					  data:formData,
					  processData:false,//设置ajax提交请求之前是否把参数统一转换成字符串true--是--false--不是默认是 true
					  contentType:false,//设置ajax向后台提交参数之前,是否把所有的参数按urlencoded编码;true是false不是
					  type:'post',
					  dataType:'json',
					  success:function (data) {
                       if(data.code==1){
